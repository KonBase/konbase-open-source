...
import { isConfigured } from "@/lib/config-store.ts";
...
const RedeemInvitationPages = () => {
  ...
  const handleRedeemCode = async () => {
    ...
    try {
      ...
      // Get convention details for the success message
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh]">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle>Redeem Invitation Code</CardTitle>
          <CardDescription>
            Enter the invitation code generated by the convention organizer to join the event.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form
          ...
          >
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                disabled={isLoading || redeemStatus === 'success'}
              />
            </div>
...
export default RedeemInvitationPages;
